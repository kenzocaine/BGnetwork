...
noise = {
            ...
            'D1' : {'rate' : 2900.0, 'start':start,'stop':stop},
            'D2' : {'rate' : 2650.0, 'start':start,'stop':stop},
            'FSN' : {'rate' : 900.0, 'start':start,'stop':stop},
            'STN' : {'rate' : 1400.0, 'start':start,'stop':stop},
            'GPTA' : {'rate' : 480.0, 'start':start,'stop':stop},
            'GPTI' : {'rate' : 2250.0, 'start':start,'stop':stop},
}
...
"GPI": {"D1": 0,"D2":0,"FSN":0,"GPTA":0,"GPTI":0,"STN":0,"GPI":0, "CTX":0},
}
