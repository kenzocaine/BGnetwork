...
"GPTA": {"D1": 0,"D2":0,"FSN":0,"GPTA":1,"GPTI":1,"STN":1,"CTX":1,},
"GPTI": {"D1": 0,"D2":1,"FSN":0,"GPTA":1,"GPTI":1,"STN":1,"CTX":1,},
...
noise = {
            ...
            'STN' : {'rate' : 230.0, 'start':start,'stop':stop},
            'GPTA' : {'rate' : 60.0, 'start':start,'stop':stop},
            'GPTI' : {'rate' : 2100.0, 'start':start,'stop':stop},
            'GPI' : {'rate' : 1800.0, 'start':start,'stop':stop}
}
...
staticsynNoise = {
            ...
            'GPTI' : {'weight' : {'distribution': 'uniform', 'low': 1.0, 'high': 1.5},'delay':1},
            'GPI' : {'weight' : {'distribution': 'uniform', 'low': 10.4, 'high': 10.5},'delay':1}
}
...
"STN": {"D1": 0,"D2":0,"FSN":0,"GPTA":0,"GPTI":1,"STN":0,"GPI":0, "CTX":1},
...
staticsyn = {   
                'D1' : {
                        ...
                        'D2': {'weight': -0.225, 'delay': 1.7}, 
                        'FSN': {'weight': -3.0, 'delay': 1.7}, 
                        'GPTA': {'weight': -0.02, 'delay': 7.0}, 
                        'GPTI': {'weight': 0.0, 'delay': 7.0}, 
                        'STN': {'weight': 0.0, 'delay': 1.0}, 
                        'GPI': {'weight': 0.0, 'delay': 1.0}
                        }, 

                'D2' : {
                        'D1': {'weight': -0.188, 'delay': 1.7}, 
                        'D2': {'weight': -0.175, 'delay': 1.7}, 
                        'FSN': {'weight': -3.0, 'delay': 1.7}, 
                ...
                "GPTA" : {
                        'D1': {'weight': 0.0, 'delay': 1.0}, 
                        'D2': {'weight': 0.0, 'delay': 1.0}, 
                        'FSN': {'weight': -1.0, 'delay': 1.0}, 
                        'GPTA': {'weight': -0.16, 'delay': 1.0}, 
                        'GPTI': {'weight': -0.16, 'delay': 1.0}, 
                ...
                "STN" : {
                        'D1': {'weight': 0.0, 'delay': 1.0}, 
                        'D2': {'weight': 0.0, 'delay': 1.0}, 
                        'FSN': {'weight': 0.0, 'delay': 1.0}, 
                        'GPTA': {'weight': 0.0, 'delay': 1.0}, 
                        'GPTI': {'weight': -0.04, 'delay': 1.0}, 
                        'STN': {'weight': 0.0, 'delay': 1.0}, 
                        'GPI': {'weight': 0.0, 'delay': 1.0}
                        },
                ...
                "GPI" :  {
                        ...
                        'D2': {'weight': 0.0, 'delay': 1.0}, 
                        'FSN': {'weight': 0.0, 'delay': 1.0}, 
                        'GPTA': {'weight': 0.0, 'delay': 3.0}, 
                        'GPTI': {'weight': -35.0, 'delay': 3.0}, 
...
testsyn = {
                "D1" : {
                        "ex" : {"weight" : 1.4, "delay" : 1.7},
                        "in" : {"weight" : -1.0, "delay" : 1.7} , 
                ...
                "GPTA" : {
                        "ex" : {"weight" : 1.0, "delay" : 1.0},
                        "in" : {"weight" : -1.0, "delay" : 1.0},
                      
                        },

                "GPTI" : {
                        "ex" : {"weight" : 0.25, "delay" : 1.0},
                        "in" : {"weight" : -1.0, "delay" : 7.0},
...
for TARGET in cparamOLD1:
    cparam[TARGET] = dict()
    for SOURCE in cparamOLD1[TARGET]:
        cparam[TARGET][SOURCE] = float(cparamOLD1[TARGET][SOURCE]) * 2



pparam = {'D1': 5000, 'D2': 5000, 'FSN': 210, 'GPTA': 658, 'GPTI': 1976, 'GPI': 1508, 'STN': 776}
...
"GPTI" : {"a" : 2.5, "b" : 70.0, "Delta_T" : 1.7, "tau_w": 20.0,
          "E_L": -55.1, "g_L": 1.0,  "C_m": 40.0,"I_e":12.0, "V_peak":15.00,
            ...
            "tau_syn_ex":2.0, "tau_syn_in":6.0 ,'V_m': -55.1, 'E_in' : -65.0, 'E_ex': 0.0
            },
            
"GPTA" : {"a" : 2.5, "b" : 105.0, "Delta_T" : 2.55, "tau_w": 20.0,
          "E_L": -55.1, "g_L": 1.0,  "C_m": 60.0,"I_e":1.0, "V_peak":15.0,
            "V_reset": -60.0, "V_th": -50.7,
            "tau_syn_ex":2.0, "tau_syn_in":5.0 , 'V_m' : -55.1, 'E_in' : -65.0, 'E_ex': 0.0
            },

"GPI" : {"a" : 3.0, "b" : 200.0, "Delta_T" : 1.8, "tau_w": 20.0,
          "E_L": -55.8, "g_L": 3.0,  "C_m": 80.0,"I_e":15.0, "V_peak":20.0,
            "V_reset": -65.0, "V_th": -50.2,
            "tau_syn_ex":12.0, "tau_syn_in":2.0 , 'V_m' : -55.8, 'E_in' : -80.0, 'E_ex': 0.0
            },

"STN" : {"a" : 0.3, "b" : 0.05, "Delta_T" : 16.2, "tau_w": 333.0,
          "E_L": -80.2, "g_L": 10.0, "C_m": 60.0, "I_e":5.0,
            "V_reset": -70.0, "V_th": -64.0, "V_peak": 15.0,
            "tau_syn_ex":2.0, "tau_syn_in":6.0, 'V_m' :  -80.2, 'E_in' : -84.0, 'E_ex': 0.0
            },
# West2016 param "FSN" : {"a" : 0.2, "b" : 0.025, "c": -60, "C_m" : 80, "d": 0, "k": 1,
#            "beta_V_r": -0.078, "v_b": -55, "v_peak": 25, "v_reset": -64, "v_th" : -50}
"FSN" : {"V_m" : -80.0, "E_ex" : 0.0, "E_in": -76.0, "V_th": -50.0, "tau_syn_ex":12.0, "tau_syn_in":6.0,
            "C_m": 80.0, "g_L": 20.0, "I_e" : 500.0,"E_L":-80.0},
"D1" : {"V_m" : -78.2, "E_ex" : 0.0, "E_in": -74.0, "V_th": -29.7, "tau_syn_ex":2.0, "tau_syn_in":8.0,
            "C_m": 200.0, "g_L": 12.5, "I_e":350.0,"E_L":-78.2},
"D2" : {"V_m" : -80.0, "E_ex" : 0.0, "E_in": -74.0, "V_th": -29.7, "tau_syn_ex":12.0, "tau_syn_in":8.0,
