...
#  Param test 5, changes to the inhibition strength to STN, and possibly delays
#  Oscillating at over 60 Hz (14 peaks each 200 ms)
# 
# 
state = {
...
noise = {
            ...
            'D1' : {'rate' : 2800.0, 'start':start,'stop':stop},
            'D2' : {'rate' : 2400.0, 'start':start,'stop':stop},
            'FSN' : {'rate' : 850.0, 'start':start,'stop':stop},
            'STN' : {'rate' : 2500.0, 'start':start,'stop':stop},
            'GPTA' : {'rate' : 220.0, 'start':start,'stop':stop},
            'GPTI' : {'rate' : 2000.0, 'start':start,'stop':stop},
            'GPI' : {'rate' : 1500.0, 'start':start,'stop':stop}
}
...
staticsyn = {   
                ...
                "GPTI" : {  
                        ...
                        'STN': {'weight': 0.175*3.0, 'delay': 5.0}, 
                        'GPI': {'weight': 0.0, 'delay': 1.0}
                        },
                ...
                "STN" : {
                        ...
                        'GPTI': {'weight': -0.04*40.0, 'delay': 5.0}, 
                        'STN': {'weight': 0.0, 'delay': 1.0}, 
                        'GPI': {'weight': 0.0, 'delay': 1.0}
                        },
