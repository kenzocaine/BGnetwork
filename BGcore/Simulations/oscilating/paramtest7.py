...
#  Rectifiyng for the oscillations due to reccurent inhibiton in D2. Reducing reccurent weight D2
# 
# 
state = {
...
"FSN": {"D1": 0,"D2":0,"FSN":0,"GPTA":1,"GPTI":0,"STN":0,"CTX":1},
...
noise = {
            ...
            'D2' : {'rate' : 2450.0, 'start':start,'stop':stop},
            'FSN' : {'rate' : 1000.0, 'start':start,'stop':stop},
            'STN' : {'rate' : 1800.0, 'start':start,'stop':stop},
            'GPTA' : {'rate' : 280.0, 'start':start,'stop':stop},
            'GPTI' : {'rate' : 1800.0, 'start':start,'stop':stop},
            'GPI' : {'rate' : 1200.0, 'start':start,'stop':stop}
}
...
"FSN": {"D1": 0,"D2":0,"FSN":0,"GPTA":1,"GPTI":0,"STN":0,"GPI":0, "CTX":1},
...
staticsyn = {   
                ...
                'D2' : {
                        ...
                        'D2': {'weight': -0.175/4, 'delay': 1.7}, 
                        'FSN': {'weight': -3.0, 'delay': 1.7}, 
                        'GPTA': {'weight': -0.04*10, 'delay': 7.0}, 
                        'GPTI': {'weight': 0.0, 'delay': 7.0}, 
                        'STN': {'weight': 0.0, 'delay': 1.0}, 
                        'GPI': {'weight': 0.0, 'delay': 1.0}
                        },
