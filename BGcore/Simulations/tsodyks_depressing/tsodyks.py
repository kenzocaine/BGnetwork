...
import BGcore.Simulations.tsodyks_depressing.param as param# Desired parameters
# Import nest
import nest
import numpy as np
...
mySetup1 = setup1(param.nparam, param.cparam, param.staticsyn, param.noise,param.staticsynNoise, param.connections,param.pparam)
...
#mySetup1.connectMultimeterNew(True)
mySetup1.setIe(0.0)
