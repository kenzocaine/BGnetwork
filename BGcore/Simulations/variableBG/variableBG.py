...
import BGcore.Simulations.BasalFiring.paramtest8noGPI as param # Desired parameters
...
if vary:
    ...
    for i in it[0:]:
        ...
        pathTest = '/Users/kimhedelin/Google Drive/VT18/Neuroscience/simulation/BGnetwork/BGcore/Simulations/variableBG/datatest/'
        dirName = pathTest+'S'+str(count)+'-'+str(round(r,2))+''+str(round(jGPTI,2))+'-'+str(round(jSTN,2))
