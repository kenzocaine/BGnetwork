...
noise = {
            ...
            'D1' : {'rate' : 546.0, 'start':200.0,'stop':500.0},
            'D2' : {'rate' : 722.0, 'start':200.0,'stop':500.0},
            'FSN' : {'rate' : 787.0, 'start':200.0,'stop':500.0},
            'STN' : {'rate' : 250.0, 'start':200.0,'stop':500.0},
            'GPTA' : {'rate' : 200.0, 'start':200.0,'stop':500.0},
            'GPTI' : {'rate' : 1530.0, 'start':200.0,'stop':500.0},
            'GPI' : {'rate' : 1800.0, 'start':200.0,'stop':500.0}
}

staticsynNoise = {
            'D1' : {'weight' : {'distribution': 'uniform', 'low': 5.5, 'high': 8.5},'delay':1},
            'D2' : {'weight' : {'distribution': 'uniform', 'low': 5.5, 'high': 8.5},'delay':1},
            'FSN' : {'weight' : {'distribution': 'uniform', 'low': 5.5, 'high': 8.5},'delay':1},
            'STN' : {'weight' : {'distribution': 'uniform', 'low': 5.0, 'high': 8.5},'delay':1},
            'GPTA' : {'weight' : {'distribution': 'uniform', 'low': -10.5, 'high': -7.5},'delay':1},
            'GPTI' : {'weight' : {'distribution': 'uniform', 'low': -10.5, 'high': -7.5},'delay':1},
            'GPI' : {'weight' : {'distribution': 'uniform', 'low': 5.5, 'high': 7.5},'delay':1}
}
...
"FSN" : {"V_m" : -80.0, "E_ex" : 0.0, "E_in": -76.0, "V_th": -54.0, "tau_syn_ex":2.0, "tau_syn_in":2.0,
            "C_m": 500.0, "g_L": 25.0, "I_e" : 500.0},
"D1" : {"V_m" : -80.0, "E_ex" : 0.0, "E_in": -64.0, "V_th": -45.0, "tau_syn_ex":2.0, "tau_syn_in":2.0,
            "C_m": 200.0, "g_L": 12.5, "I_e":350.0},
"D2" : {"V_m" : -80.0, "E_ex" : 0.0, "E_in": -64.0, "V_th": -45.0, "tau_syn_ex":2.0, "tau_syn_in":2.0,
            "C_m": 200.0, "g_L": 12.5, "I_e": 350.0}
}
