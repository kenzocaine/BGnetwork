...
noise = {
            ...
            'D1' : {'rate' : 3000.0, 'start':start,'stop':stop},
            'D2' : {'rate' : 2600.0, 'start':start,'stop':stop},
            'FSN' : {'rate' : 1300.0, 'start':start,'stop':stop},
            'STN' : {'rate' : 1230.0, 'start':start,'stop':stop},
            'GPTA' : {'rate' : 80.0, 'start':start,'stop':stop},
            'GPTI' : {'rate' : 1300.0, 'start':start,'stop':stop},
            'GPI' : {'rate' : 2300.0, 'start':start,'stop':stop}
}
...
staticsynNoise = {
            ...
            'GPI' : {'weight' : {'distribution': 'uniform', 'low': 3.0, 'high': 3.2},'delay':1}
}


connections = {
"D1": {"D1": 1,"D2":1,"FSN":1,"GPTA":1,"GPTI":0,"STN":0,"CTX":1},
"D2": {"D1": 1,"D2":1,"FSN":1,"GPTA":1,"GPTI":0,"STN":0,"CTX":1},
"GPTA": {"D1": 0,"D2":0,"FSN":0,"GPTA":1,"GPTI":1,"STN":1,"CTX":0},
"GPTI": {"D1": 0,"D2":1,"FSN":0,"GPTA":1,"GPTI":1,"STN":1,"CTX":0},
"STN": {"D1": 0,"D2":0,"FSN":0,"GPTA":0,"GPTI":1,"STN":0,"CTX":1},
"FSN": {"D1": 0,"D2":0,"FSN":1,"GPTA":1,"GPTI":1,"STN":0,"CTX":1},
...
for TARGET in cparamOLD1:
    ...
    for SOURCE in cparamOLD1[TARGET]:
        cparam[TARGET][SOURCE] = cparamOLD1[TARGET][SOURCE] * 2
...
"GPTI" : {"a" : 2.5, "b" : 70.0, "Delta_T" : 1.7, "tau_w": 20.0,
          "E_L": -55.1, "g_L": 1.0,  "C_m": 40.0,"I_e":12.0, "V_peak":15.0,
            ...
            "tau_syn_ex":2.0, "tau_syn_in":2.0 ,'V_m': -55.1, 'E_in' : -65.0, 'E_ex': 0.0
            },
...
"STN" : {"a" : 0.3, "b" : 0.05, "Delta_T" : 16.2, "tau_w": 333.0,
          "E_L": -80.2, "g_L": 10.0, "C_m": 60.0, "I_e":5.0,
            ...
            "tau_syn_ex":2.0, "tau_syn_in":2.0, 'V_m' :  -80.2, 'E_in' : -84.0, 'E_ex': 0.0
            },
...
"D1" : {"V_m" : -78.2, "E_ex" : 0.0, "E_in": -74.0, "V_th": -29.7, "tau_syn_ex":2.0, "tau_syn_in":2.0,
            "C_m": 200.0, "g_L": 12.5, "I_e":350.0,"E_L":-78.2},
"D2" : {"V_m" : -80.0, "E_ex" : 0.0, "E_in": -74.0, "V_th": -29.7, "tau_syn_ex":2.0, "tau_syn_in":2.0,
