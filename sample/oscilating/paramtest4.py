...
#  Param test 4, yields a small oscillation of 15*5 for GPTI, and barely visible for stn (input D2 3900)
# 
# 
state = {
...
noise = {
            ...
            'GPTI' : {'rate' : 1600.0, 'start':start,'stop':stop},
...
staticsyn = {   
                ...
                "GPTI" : {  
                        ...
                        'STN': {'weight': 0.175*3.0, 'delay': 2.0}, 
                        'GPI': {'weight': 0.0, 'delay': 1.0}
                        },
                ...
                "STN" : {
                        ...
                        'GPTI': {'weight': -0.04*20.0, 'delay': 1.0}, 
                        'STN': {'weight': 0.0, 'delay': 1.0}, 
                        'GPI': {'weight': 0.0, 'delay': 1.0}
                        },
